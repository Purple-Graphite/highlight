...
final python = Mode(
    refs: {
      '~contains~6~contains~1': Mode(className: "params", variants: [
        Mode(begin: "\\(\\s*\\)", skip: true, className: null),
        Mode(
            begin: "\\(",
            end: "\\)",
            excludeBegin: true,
      ...
      '~contains~4': Mode(className: "string", contains: [
        BACKSLASH_ESCAPE
      ], variants: [
        Mode(
        ...
        Mode(
            ...
            contains: [BACKSLASH_ESCAPE, Mode(ref: '~contains~0')],
            relevance: 10),
        Mode(begin: "([fF][rR]|[rR][fF]|[fF])'''", end: "'''", contains: [
          BACKSLASH_ESCAPE,
          Mode(ref: '~contains~0'),
