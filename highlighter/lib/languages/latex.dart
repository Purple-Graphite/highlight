...
final latex = Mode(
    refs: {
      ...
      '~contains~2~starts~starts~contains~0~contains~0~contains~6': Mode(
          ...
          relevance: 0),
      '~contains~2~starts~starts~contains~0~contains~0~contains~5':
          Mode(className: "meta", begin: "% !TeX", end: "\$", relevance: 10),
      '~contains~2~starts~starts~contains~0~contains~0~contains~4':
      ...
      '~contains~2~starts~starts~contains~0~contains~0~contains~1':
          Mode(className: "keyword", begin: "\\\\", relevance: 0, contains: [
        Mode(
            endsParent: true,
            begin:
        ...
        Mode(
            endsParent: true,
            relevance: 0,
            variants: [Mode(begin: "[a-zA-Z@]+"), Mode(begin: "[^a-zA-Z@]?")])
      ]),
    ...
    contains: [
      ...
      Mode(
          ...
          starts: Mode(
              ...
              starts: Mode(
                  relevance: 0,
                  contains: [Mode(ref: '~contains~2~starts~starts~contains~0')],
                  starts: Mode(contains: [
                    Mode(
                        className: "string",
                        begin: "(.|\\r?\\n)",
              ...
              starts: Mode(
                  ...
                  starts: Mode(contains: [
                    Mode(
                        relevance: 0,
                        begin: "\\{",
                        starts: Mode(endsParent: true, contains: [
                          Mode(
                              className: "string",
                              end: "(?=\\})",
                              endsParent: true,
      ...
      Mode(
          ...
          starts: Mode(
              ...
              starts: Mode(
                  relevance: 0,
                  contains: [Mode(ref: '~contains~6~starts~starts~contains~0')],
                  starts: Mode(contains: [
                    Mode(
                        relevance: 0,
                        begin: "\\{",
